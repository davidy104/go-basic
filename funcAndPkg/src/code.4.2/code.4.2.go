/**
* anonymous func, for those functions are mostly not reusable , specific to some functions
**/
package main
...
//anonymous func can not be called from outside,
//must be assigned a variable
//anonymous func has no name
